...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["id", "username", "email", "first_name", "last_name", "role", "is_superuser", "is_staff", "permissions", "active_memberships", "corporate_memberships"]
        read_only_fields = ["id", "is_superuser", "is_staff", "permissions", "active_memberships", "corporate_memberships"]
